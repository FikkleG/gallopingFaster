#ifndef PROJECT_LIMAUSERPARAMETERS_H
#define PROJECT_LIMAUSERPARAMETERS_H

#include "ControlParameters/ControlParameters.h"

class LIMAuserParameters : public ControlParameters {
public:
    LIMAuserParameters()
...
#endif //PROJECT_LIMAUSERPARAMETERS_H
