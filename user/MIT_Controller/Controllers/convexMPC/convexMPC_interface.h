...
EXTERNC void update_problem_data(double* p, double* v, double* q, double* w, double* r, double yaw, double pitch, double* weights, double* state_trajectory, double alpha, int* gait);
...
EXTERNC void update_problem_data_floats(float* p, float* v, float* q, float* w,
                                        float* r, float yaw, float pitch, float* weights,
